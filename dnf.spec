...
Version  : 2.7.4
Release  : 10
URL      : https://github.com/rpm-software-management/dnf/archive/2.7.4.tar.gz
Source0  : https://github.com/rpm-software-management/dnf/archive/2.7.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1508281462
mkdir clr-build
pushd clr-build
